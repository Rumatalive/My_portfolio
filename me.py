...
if 'name' not in st.session_state:
    st.session_state.name = "Fabrice Nsanzamahoro"
if 'location' not in st.session_state:
    st.session_state.location = "Musanze, Rwanda" 
if 'bio' not in st.session_state:
    st.session_state.bio = "I am a final-year Software Engineering student passionate about AI development, web and mobile apps, and integrating software with hardware. I am working on an AI-powered stroke detection app for my dissertation and developing projects like MataHub (AI music), MataBet (betting site), Ikimata Magazine (news platform), and a telemedicine platform. I also run Digital Youth Hub, a blog on digital skills, and aim to create tech solutions for Rwanda."

# Home section
if page == "Home":
    st.title("🧑‍🎓 Student Profile")
    st.image("me.jpg", width=150, caption="Nsanzamahoro Fabrice")
...
# Projects section
    ...
    project_data = {
        "Year 1 Project": {
            "ikimata-press-haven(Ikimata News Platform )": {
                "type": "Individual",
                "description": "Ikimata Press Haven is a digital media platform providing in-depth coverage of sports, politics, entertainment, health, and technology. It offers real-time news updates, interactive discussions, and a seamless reading experience for a global audience..",
                "link": "https://github.com/Rumatalive/dample.git"
            }
        },
        "Year 2 Project": {
            "🤖 MataFlix-movie_magic": {
                "type": "Group",
                "description": "MataFlix – Movie Magic is a streaming platform that offers a vast collection of movies, TV shows, and exclusive content, delivering a seamless and immersive viewing experience with personalized recommendations..",
                "link": "https://github.com/Rumatalive/mataflix-movie-magic.git"
            }
        },
        "Year 3 Project": {
            "🌐 Ines Website": {
                ...
                "link": "https://github.com/ines-website"
            }
        },
        "Dissertation": {
            "🌍 Designing A Basic AI-Powered Symptom Checker for Stroke Detection in Rwanda": {
                "type": "Individual",
                "description": "This project aims to develop a mobile app that uses AI to detect stroke symptoms based on the FAST criteria (Face drooping, Arm weakness, Speech difficulty, Time to act). The app will analyze user input and provide immediate feedback, helping with early stroke detection and timely medical intervention.",
    ...
    testimonials = [
    "Fabrice demonstrates exceptional problem-solving skills, and his final year project on AI-driven stroke detection is truly impressive. – Dr. Theodore",
    "Fabrice's passion for AI and his continuous learning make him an inspiring individual to work with. – Lecturer McClement",
    "As a team leader and developer, Fabrice consistently delivers innovative and high-quality projects. – Teammate CKM"
    ]
    ...
    milestones = [
        "✅ Year 2023: C programming project completed",
        "🏆 Year 2024: Participated in national AI hackathon in Kigali",
        "💼 08/07/2025: Internship with AI-based healthcare platform",
...
# Contact section
    ...
    st.markdown("📧 Email: **Nsanzamahoro250fabrice@gmail.com**")
    st.markdown("[📂 GitHub](https://github.com/Rumatalive)")
    st.markdown("[📂 LinkedIn](https://www.linkedin.com/in/eng-nsanzamahoro-fabrice-04a384326/)")
...
if page == "Testimonials":
    ...
    st.write("*Fabrice demonstrates exceptional problem-solving abilities, and his final year project on AI-powered stroke detection is remarkable. – Mr. clement*")
